...
@Entity
@Table(name = "warehouse_products_order")
public class OrderItem implements Serializable, Cloneable {
    ...
    @Column(name = "line_number_identity")
    private Integer lineNumberIdentity;
    ...
    private OrderLocalDocument orderLocalDocument;
    ...
    public Integer getLineNumberIdentity() {
        return lineNumberIdentity;
    }

    public void setLineNumberIdentity(Integer lineNumberIdentity) {
        this.lineNumberIdentity = lineNumberIdentity;
    }
