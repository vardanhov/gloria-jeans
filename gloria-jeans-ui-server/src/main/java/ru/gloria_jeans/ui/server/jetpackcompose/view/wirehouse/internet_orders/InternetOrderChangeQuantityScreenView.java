...
public class InternetOrderChangeQuantityScreenView extends Screen {
    @JsonIgnore
    private Container mainContainer;
    private String urlToBack;

    public InternetOrderChangeQuantityScreenView(String urlToBack) {
        ...
        action.setActionUri(
                String.format("%s/%s",
                        ...
                        WarehouseScreen.INTERNET_ORDERS_CHANGE_QUANTITY_UPDATE.getWarehouseScreen()
                )
        );
